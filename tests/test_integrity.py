...
check("04 connected screens", all((SRC / item).exists() for item in [
    "project-import.html", "knowledge-search.html", "memory-center.html", "design-controller.html",
]))
...
runtime_pages = ["vas-hub.html", "project-import.html", "knowledge-search.html", "memory-center.html"]
check("15 runtime client wiring", all("runtime-client.js" in text(SRC / page) for page in runtime_pages))
