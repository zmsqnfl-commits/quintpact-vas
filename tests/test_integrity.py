"""VAS 2.7.6 단일 무결성 검사: 핵심 시스템 경계를 한 번 확인합니다."""
...
check("01 package version", package.get("version") == "2.7.6")
check("02 runtime version", "version: '2.7.6'" in config or 'version: "2.7.6"' in config)
